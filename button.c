...
uint8_t button_getButton() {
    ...
    if ((GPIO_PORTE_DATA_R & 0b00001000) == 0x00) { //Checks if bit 3 is a 0 (button 4 is pressed)

    return 4;

    }

    if ((GPIO_PORTE_DATA_R & 0b00000100) == 0x00) { //Checks if bit 2 is a 0 (button 3 is pressed)

    return 3;

    }

    if ((GPIO_PORTE_DATA_R & 0b00000010) == 0x00) { //Checks if bit 1 is a 0 (button 2 is pressed)

    return 2;

    }

    if ((GPIO_PORTE_DATA_R & 0b00000001) == 0x00) { //Checks if bit 0 is a 0 (button 1 is pressed)
